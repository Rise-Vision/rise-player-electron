...
gcloud auth activate-service-account 452091732215@developer.gserviceaccount.com --key-file ./private-keys/storag-server/rva-media-library-ce0d2bd78b54.json
...
mv player.sh build
cd build && 7z a -mx4 player.7z player.asar
