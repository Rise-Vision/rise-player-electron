...
const configLogger = requireRoot("installer/loggers/config-logger.js");
const widgetLogger = requireRoot("installer/loggers/widget-logger");
const watchdog = requireRoot("installer/watchdog.js");
const onlineDetection = requireRoot("installer/online-detection.js");
const viewerContentLoader = requireRoot("viewer/content-loader.js");
